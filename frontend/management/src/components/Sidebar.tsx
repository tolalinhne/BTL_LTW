...
const NAV_ITEMS: NavItem[] = [
    { id: 'dashboard', label: 'Dashboard', path: '/dashboard', icon: LayoutDashboard, roles: ['staff', 'admin'] },
    { id: 'orders', label: 'Đơn hàng', path: '/orders', icon: Truck, roles: ['staff', 'admin'] },
    { id: 'products', label: 'Sản phẩm', path: '/products', icon: ShoppingBag, roles: ['admin'] },
    { id: 'categories', label: 'Danh mục', path: '/categories', icon: Layers, roles: ['admin'] },
    { id: 'users', label: 'Người dùng', path: '/users', icon: Users, roles: ['admin'] },
    { id: 'statistics', label: 'Thống kê', path: '/statistics', icon: BarChart3, roles: ['admin'] },
];
